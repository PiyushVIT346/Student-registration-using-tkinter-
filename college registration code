...
class Student:
    def __init__(self,root):
       ...
       #1st image 
        ...
        img=img.resize((555,250),Image.LANCZOS)
        ...
        #img 1
        img_7=Image.open('university.png')
        img_7=img_7.resize((798,200),Image.LANCZOS)
    ...
    def add_data(self):
        if (self.var_enrollment.get()=="" or self.var_name.get()=="" or self.var_course.get()==""):
            ...
            try:
                conn=mysql.connector.connect(host="localhost",user="root",password="mysql",database="student_management_system")
    ...
    def update_data(self):
        if (self.var_enrollment.get()=="" or self.var_name.get()=="" or self.var_course.get()==""):
            ...
            try:
                ...
                if update>0:
                    conn=mysql.connector.connect(host="localhost",user="root",password="2030",database="student_management_system")
                    my_cursur=conn.cursor()
